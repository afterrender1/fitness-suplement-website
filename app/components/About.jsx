            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 mb-12 md:mb-16 lg:mb-24 items-end">
                    <div className="lg:col-span-7 xl:col-span-8">
                        ...
                        <h2
                            className={`${poppins.className} text-[clamp(2rem,6vw,4.5rem)] font-bold text-slate-900 leading-[1.05] sm:leading-none`}
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                    ...
                    <div className="lg:col-span-7">
                        <div className="relative w-full aspect-3/4 sm:aspect-4/5 md:aspect-3/4 lg:aspect-4/5 rounded-3xl overflow-hidden bg-slate-100 shadow-2xl shadow-slate-200/50">
                            <Image
                                ...
                                className="object-cover transition-all duration-700 sm:group-hover:scale-105 sm:group-hover:brightness-105"
                            />
                            ...
                            <div className="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-4 sm:left-6 lg:left-8 right-4 sm:right-auto">
                                <div className="flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-xl border border-white/20 px-3 py-2 sm:px-4 sm:py-3 rounded-full text-white shadow-lg">
                                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-teal-500 flex items-center justify-center shrink-0">
                                        <Zap size={16} className="sm:size-18" fill="white" />
                                    </div>
                                    <span className="text-[10px] sm:text-xs lg:text-sm font-bold tracking-wide truncate">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-4 sm:gap-6">
                        ...
                        {/* Research Card */}
                        <div className="bg-[#F3F7F8] flex-1 rounded-2xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-10 flex flex-col justify-between">
                            ...
                            <div className="flex flex-wrap gap-2 mt-4 sm:mt-6">
                                {["No Fillers", "No Banned Subs", "Vegan", "Non-GMO"].map((tag, i) => (
                                    <span
                                        key={tag}
                                        className="text-[8px] sm:text-[10px] lg:text-xs font-bold uppercase tracking-wider px-2.5 py-1 sm:px-3 sm:py-1.5 bg-white rounded-full border border-slate-200 cursor-default"
                        ...
                        {/* Stats Cards */}
                        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mt-4 sm:mt-6">
                            <div className="relative bg-slate-900 rounded-2xl p-4 sm:p-6 lg:p-8 text-white flex flex-col items-center justify-center text-center overflow-hidden min-h-35 sm:min-h-40">
                                <Trophy size={64} className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 opacity-10" />
                                <h4 className="text-2xl sm:text-3xl lg:text-4xl font-semibold leading-none mb-1 sm:mb-2 relative z-10">100+</h4>
                                <p className="text-slate-400 text-[9px] sm:text-[10px] lg:text-xs font-semibold uppercase tracking-widest relative z-10">Pro Athletes</p>
                            </div>

                            <div className="relative bg-teal-500 rounded-2xl p-4 sm:p-6 lg:p-8 text-white flex flex-col items-center justify-center text-center overflow-hidden min-h-35 sm:min-h-40">
                                ...
                                <p className="font-semibold text-[10px] sm:text-sm lg:text-base leading-tight relative z-10 text-center">
                                    NSF Certified <br className="hidden sm:block" /> Formula
                                </p>
                            </div>
                        </div>

                        {/* Mini Card (Desktop Only) */}
                        <div className="hidden lg:flex bg-white border border-gray-200 rounded-xl p-6 items-center gap-4 mt-4">
                ...
                <div className="mt-12 sm:mt-16 lg:mt-24 flex flex-col md:flex-row gap-6 md:gap-8 items-center justify-between border-t border-slate-100 pt-8 sm:pt-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 sm:gap-10 lg:gap-16 grayscale cursor-default">
                        {['LAB-CORP', 'EURO-BIO', 'HEALTH-LINE', 'NSF'].map((brand) => (
                            <span key={brand} className="text-sm sm:text-base lg:text-lg font-black italic tracking-tighter text-slate-900">
                                {brand}
                            </span>
                        ))}
                    </div>
